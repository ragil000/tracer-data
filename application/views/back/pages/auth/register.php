...
<head>
	...
	<title>Pharmacy Tracer Data | Register</title>
                                    ...
                                    <form action="<?=base_url('register/create')?>" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="nim" class="form-control" placeholder="nim" aria-label="nim" aria-describedby="basic-addon1" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 text-center text-primary mt-2">
                                                <a href="<?=base_url('login')?>"><small>Sudah punya akun?</small></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
